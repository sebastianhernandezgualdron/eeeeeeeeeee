...
flechasIcon = document.querySelectorAll("#sliderContainer4 i")
...
const mostarIconos4 = () =>{
    ...
    flechasIcon[0].style.display = slider4.scrollLeft == 0 ? "block" : "block"
    flechasIcon[1].style.display = slider4.scrollLeft == scrollWidth4 ? "block" : "block"
}
