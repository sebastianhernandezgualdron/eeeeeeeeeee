const slider3 = document.getElementById("sliderImg3");
primeraImg = slider3.querySelectorAll("div")[0];
flechasIcon = document.querySelectorAll("#sliderContainer3 i")
...
const mostarIconos2 = () =>{
    ...
    flechasIcon[0].style.display = slider3.scrollLeft == 0 ? "block" : "block"
    flechasIcon[1].style.display = slider3.scrollLeft == scrollWidth2 ? "block" : "block"
}
