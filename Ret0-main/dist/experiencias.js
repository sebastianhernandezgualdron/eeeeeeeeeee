const slider2 = document.getElementById("sliderImg2");
primeraImg = slider2.querySelectorAll("div")[0];
flechasIcon = document.querySelectorAll("#sliderContainer2 i")
...
flechasIcon.forEach(icon => {
    icon.addEventListener("click", () => {
        ...
        slider2.scrollLeft += icon.id == "iconR" ? -primeraImgWidth : primeraImgWidth;
